...
import (
	...
	"server/response-srv/handler"
	response_proto "server/response-srv/proto/response"
	"time"
...
func main() {
	...
	m := telegraf.NewMetrics(
		metrics.Namespace(conf.Get("service", "name").String("response")),
		metrics.Collectors(
	...
	response_proto.RegisterResponseServiceHandler(service.Server(), new(handler.ResponseService))
